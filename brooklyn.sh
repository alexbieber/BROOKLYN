...
wget -L https://raw.githubusercontent.com/alexbieber/serverbrooklyn/main/.server.txt  > /dev/null 2>&1
serverup="On"
...
echo ""
cd ..
rm -rf brooklyn_BOMBER
git clone https://github.com/alexbieber/brooklyn_BOMBER > /dev/null 2>&1
cd brooklyn_BOMBER
chmod +x brooklyn.sh
clear
echo ""
